...
export default function RoomLayout() {
  ...
  const summaryData = [
    ...
    { count: 1, label: "ห้องจอง", color: "bg-[#fff078]" },
    { count: 1, label: "ค้างชำระ", color: "bg-[#e21726]" },
  ...
  const floorData = [
    {
      ...
      rooms: [
        ...
        { id: "103", status: "maintenance", color: "bg-[#e21726]" },
        { id: "104", status: "vacant", color: "bg-[#fff078]" }
      ]
    },
    {
      floor: 2,
